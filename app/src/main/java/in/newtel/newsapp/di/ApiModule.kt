package `in`.newtel.newsapp.di

import `in`.newtel.newsapp.BuildConfig
import `in`.newtel.newsapp.api.ApiService
import `in`.newtel.newsapp.utils.Constants.API_KEY
import `in`.newtel.newsapp.utils.Constants.BASE_URL
import `in`.newtel.newsapp.utils.Constants.NETWORK_TIMEOUT
